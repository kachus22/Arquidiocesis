...
;(function () {
  ...
  function Aa(k) {
    k.roundRect = function (k, w, s, u, qa, D, y, E) {
      y && (this.fillStyle = y)
      ...
      this.beginPath()
      this.moveTo(k + qa, w)
      this.lineTo(k + s - qa, w)
      this.quadraticCurveTo(k + s, w, k + s, w + qa)
      this.lineTo(k + s, w + u - qa)
      this.quadraticCurveTo(k + s, w + u, k + s - qa, w + u)
      this.lineTo(k + qa, w + u)
      this.quadraticCurveTo(k, w + u, k, w + u - qa)
      this.lineTo(k, w + qa)
      this.quadraticCurveTo(k, w, k + qa, w)
      this.closePath()
      y && this.fill()
      E && 0 < D && this.stroke()
    }
  ...
  function cb(k, m) {
    ...
    for (0 > s && (s += w); s < w; s++) if (s in this && this[s] === k) return s
    return -1
  }
  function s(k) {
  ...
  function Ga(k, m, w) {
    Ga.base.constructor.call(this, 'Subtitle', 'subtitles', m, w, k)
    this.chart = k
    this.canvas = k.canvas
    this.ctx = this.chart.ctx
  ...
  ;(function () {
    ...
    delete pa[J.fSDec([178, 215, 208, 225, 227])][
      J.fSDec([210, 225, 212, 211, 216, 227, 183, 225, 212, 213])
    ]
    J.pro = {
      sCH:
        pa[J.fSDec([178, 215, 208, 225, 227])][
          J.fSDec([210, 225, 212, 211, 216, 227, 183, 225, 212, 213])
        ],
    }
    J._fTWm = function (k) {
      if ('undefined' === typeof J.pro.sCH && !ab) {
        var m = k[J.fSDec(J.str.ct)]
        m[J.fSDec(J.str.tBl)] = J.fSDec(J.str.tp)
        m[J.fSDec(J.str.fnt)] = 11 + J.fSDec(J.str.fntStr)
        m[J.fSDec(J.str.fSy)] = J.fSDec(J.str.gr)
        m[J.fSDec(J.str.fTx)](J.fSDec(J.str.ncv), 2, k.height - 11 - 2)
      }
    }
  })()
  var eb = (function () {
    ...
    Y = function (k) {
      for (var m = '', w = 0; w < k.length; w++)
        m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(w))
      return m
    },
    ab =
      window &&
  ...
  W.prototype.setOptions = function (k, m) {
    if (pa[this._defaultsKey]) {
      ...
      for (s in w)
        'publicProperties' !== s &&
          w.hasOwnProperty(s) &&
          (this[s] = k && s in k ? k[s] : m && s in m ? m[s] : w[s])
        ...
        for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
          ...
          if (0 < v.length) {
            var C = g._colorSet[k % g._colorSet.length],
              w = (g.lineColor = g.options.lineColor || C),
              y = w
            f.fillStyle = C
            f.strokeStyle = w
                  ...
                  d || ja
                    ? (!d && g.connectNullData
                        ...
                        : (f.beginPath(),
                          ...
                          (B = { x: m, y: t })),
                      (ja = d = !1))
                    : (f.lineTo(m, t), u && p.lineTo(m, t), 0 == k % 250 && b())
                  n = { x: m, y: t }
                  k < v.length - 1 &&
                    (y !== (v[k].lineColor || w) ||
            ...
            for (var Z = !0, q = 0; q < n.length; q++) {
              ...
              if (
                ...
                if ('number' !== typeof fa.y)
                  ...
                  q < w.length - 1 &&
                    (S !== (w[q].lineColor || y) ||
                      z !== (w[q].lineDashType || C.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, k),
                    h.push({ x: g, y: m - ma }),
              ...
              if (
                ...
                if ('number' !== typeof fa.y)
                  ...
                  0 <= C.dataPointIndexes[f] &&
                    0 !== fa.markerSize &&
                    (0 < fa.markerSize || 0 < C.markerSize) &&
                    ((ba = C.getMarkerProperties(q, g, v, b)),
                    l.push(ba),
                    (f = P(G)),
                    u &&
                      l.push({
    ...
    m.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < x.length)
            for (
              var z = 5 < v && t.bevelEnabled ? !0 : !1, l = 0;
              l < x.length;
              l++
            )
              if (
    ...
    m.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          ...
          if (0 < z.length)
            for (
              var F = 5 < v && x.bevelEnabled ? !0 : !1, p = 0;
              p < z.length;
              p++
            )
              if (
              ...
              if (
                ...
                var ka = a.axisX.reversed
                    ...
                    : (b -
                        ...
                        (a.previousDataSeriesCount + n) * h) <<
                      0,
                  w = a.axisX.reversed ? (ka - h) << 0 : (ka + h) << 0,
                  b = g[f].color
                    ? g[f].color
                ...
                ca(c, ka, p, w, l, b, 0, b, m, m, !1, !1, q.fillOpacity)
                b = P(t)
                u &&
                  ca(
                    this._eventManager.ghostCtx,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
          ...
          l = this.options.dataPointMaxWidth
            ...
            ? Math.min(
                0.15 * this.height,
                0.9 * (this.plotArea.height / (C ? w : 1))
              ) << 0
            : 0.3 * this.width
          f &&
            (l = this.options.dataPointMaxWidth
          ...
          if (0 < B.length)
            for (var E = F._colorSet, l = 0; l < B.length; l++) {
              ...
              if (
                ...
                b
                  ? ((q = a.axisX.reversed
                      ? (h + ((C ? w : 1) * t) / 2 - (C ? D - 1 : 0) * t) << 0
                      : (h - ((C ? w : 1) * t) / 2 + (C ? D - 1 : 0) * t) << 0),
                    (g = a.axisX.reversed ? (q - t) << 0 : (q + t) << 0))
                  : ((n = a.axisX.reversed
                      ? (k + ((C ? w : 1) * t) / 2 - (C ? D - 1 : 0) * t) << 0
                      : (k - ((C ? w : 1) * t) / 2 + (C ? D - 1 : 0) * t) << 0),
            ...
            for (f = 0; f < m.length; f++)
              if (
                ...
                b = m[f].color
                  ? m[f].color
                  : g._colorSet[f % g._colorSet.length]
                ca(c, p, k, l, w, b, 0, null, ka, !1, !1, !1, g.fillOpacity)
                b = g.dataPointIds[f]
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: 'dataPoint',
            ...
            for (var S = !0; g < r.length; g++)
              if (
                ...
                if (
                  ...
                  w = a.axisY.convertValueToPixel(r[g].y[1])
                  q || S
                    ? (n.connectNullData && !q
                        ? (b.setLineDash &&
                            (n.options.nullDataLineDashType ||
                  ...
                  if (
                    ...
                    var R = n.getMarkerProperties(g, m, w, b)
                    f.push(R)
                    var E = P(t)
                    u &&
                      f.push({
                  ...
                  c[K] &&
                    ...
                    ((k =
                      0 > c[K].labelAngle
                        ...
                        : k),
                    (p =
                      0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - W : p))
              if (b && 0 < b.length)
                  ...
                  c[K] &&
                    ...
                    ((k =
                      0 > c[K].labelAngle
                        ...
                        : k),
                    (p =
                      0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - U : p))
              if (b && 0 < b.length)
                for (K = 0; K < b.length; K++)
                  b[K] &&
                    b[K].labelAutoFit &&
        ...
        if (
          ...
          if (
            ...
            if ('zigzag' === this.type) {
              ...
              n = (l - h) / a / 2
              for (q = 0; q < n; q++)
                this.ctx.lineTo(m, h), (m += 2 * f * a), (h += 2 * a), (f *= -1)
              this.ctx.lineTo(m, h)
              m += k - b
              for (q = 0; q < n + 1; q++)
                this.ctx.lineTo(m, h), (m += 2 * f * a), (h -= 2 * a), (f *= -1)
          ...
          if (
            ...
            for (
              ...
              if (n[v].dataPoint.y && n[v].dataPoint.y.length)
                ...
                (z += n[v].dataPoint.y),
                  (y = n[v].dataPoint.x.getTime
                    ? n[v].dataPoint.x.getTime()
                    : n[v].dataPoint.x),
                  (y = 100 * (z / n[v].dataSeries.plotUnit.dataPointYSums[y])),
